...
### 4. NEW: TorrServe & Link Integration
- **Direct Play:** Menu \"🔗 PLAY LINK\" allows pasting YouTube, Magnets or stream URLs.
- **TorrServe Browser:** Menu \"📥 TORRSERVE\" allows browsing torrent library and selecting files to play.
- **Local Playlists:** Support for local \`.m3u\` files on disk (use path instead of URL in settings).
...
- [x] TorrServe torrent browsing and file selection.
- [x] Direct URL/YouTube play support.
- [x] Local M3U file support.
